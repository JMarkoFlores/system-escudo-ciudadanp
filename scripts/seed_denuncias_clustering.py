"""
Seed Data para Clustering - 10 denuncias que generan 2+ clusters
Ejecutar con: python scripts/seed_denuncias_clustering.py
"""
import asyncio
import uuid
import sys
...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "intel_extorsion_agent_system"))
...
SEED_DENUNCIAS = [
    {
        "contenido": "Me llegó una carta: deposita S/. 450 semanales a la cuenta BCP 00123456789012345678 o quemamos tu negocio en El Porvenir. Tienes 48 horas.",
        "canal": "whatsapp",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Vacúnate o te picamos. Deposita 500 soles al 942847293 (Yape). Tu ferretería en El Milagro lo sabe.",
        "canal": "telegram",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Si no pagas el piso de S/. 450 semanales a la cuenta BCP 00123456789012345678, te vamos a quemar el local en El Porvenir. Tienes hasta el viernes.",
        "canal": "web",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Paga la vacuna de 500 soles al Yape 942847293 o te brincamos en El Milagro. Sabemos dónde vives.",
        "canal": "whatsapp",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Deposita S/. 450 semanales a BCP 00123456789012345678 o quemamos tu negocio en El Porvenir. Cuidadito.",
        "canal": "discord",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Llámame al 942847293. Deposita 500 soles por Yape o te picamos en El Milagro. Te estamos vigilando.",
        "canal": "telegram",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Necesito que pagues S/. 300 mensuales a la cuenta Interbank 98765432109876543210 o hacemos daño a tu familia en California.",
        "canal": "web",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Paga el cupo de 300 soles mensuales a Interbank 98765432109876543210 o te vamos a buscar en California.",
        "canal": "whatsapp",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Deposita S/. 200 semanales al BBVA 11223344556677889900 o granada en tu local de Huanchaco.",
        "canal": "discord",
        "tipo_contenido": "texto",
    },
    {
        "contenido": "Llamada amenazante: paga 200 soles semanales a BBVA 11223344556677889900 o petardo en tu negocio de Huanchaco.",
        "canal": "telegram",
        "tipo_contenido": "texto",
    },
]
